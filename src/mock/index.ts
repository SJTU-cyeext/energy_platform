...
Mock.mock("https://www.demo.com/login", "post", (options: any) => {
    ...
    if (username === "admin" && password === "admin666") {
        ...
        return {
            ...
            message: "登陆成功",
            data: {
                token: "jnnkakjfi3412143jk14321jkkadfda",
                user: {
                    username: "mty",
                    roles: ["user"],
                },
...
Mock.mock("https://www.demo.com/revenueList", "post", (option: any) => {
    chargingStation2 = originalChargingStation2

    const { name = "", page = 1, pageSize = 10 } = option.body ? JSON.parse(option.body) : {}

    // 根据条件过滤数据
    if (name) chargingStation2 = chargingStation2.filter(item => item.name.includes(name))
...
//充电桩列表接口
Mock.mock("https://www.demo.com/pileList", "post", () => {
    return {
        code: 200,
        success: true,
        data: chargingPile
