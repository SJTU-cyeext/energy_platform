            ...
            <el-card class="mt">
                ...
                <el-form :model="form" style="max-width: 600px;" label-width="85px">
                    ...
                    <el-form-item label="经度: ">
                        <el-input placeholder="请输入经度" v-model="form.lng"></el-input>
                    </el-form-item>
                    <el-form-item label="纬度: ">
                        <el-input placeholder="请输入纬度" v-model="form.lat"></el-input>
                    </el-form-item>
                    <el-form-item label="立即使用: ">
                        <el-switch v-model="form.now" />
                    </el-form-item>
                    <el-form-item label="备注: ">
                        <el-input placeholder="请输入备注" v-model="form.remark" type="textarea"></el-input>
                    </el-form-item>
                    <el-form-item>
